document.write('<style>.pace{-webkit-pointer-events:none;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;user-select:none}.pace-inactive{display:none}.pace .pace-progress{background:#d5be29;position:fixed;z-index:2000;bottom:0;right:100%;width:100%;height:5px}</style>');
