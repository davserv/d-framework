...
qrfile é um CDN de código para executar Sites, aplicativos, Editor...
...
Cdn qrfile.js
```bash
<script src="https://cdn.jsdelivr.net/gh/davserv/d-framework@refs/heads/qrcode.cdn/qrfile.js"></script>
```
